      ...
      return (
        <div className="space-y-8 p-2 md:p-0">
          ...
          {filteredEntries.length === 0 && !loading && (
            ...
            >
              <img  alt="Empty state illustration" className="mx-auto mb-4 w-40 h-40 opacity-50" src="https://unsplash.com/illustrations/a-computer-screen-with-a-picture-of-a-brain-on-it-8FMoXUTzLtk" />
